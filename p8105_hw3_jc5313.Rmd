...
#### Data cleaning
Next, I am cleaning the data and I will create separate variables for year, month, and day using `separate`. Then, I will use `mutate` to encode data with reasonable variable classes.
```{r}
